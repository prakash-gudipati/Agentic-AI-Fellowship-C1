...
Pretty console printing for the live walkthrough. The instructor narrates
against these labels: NODE, SEARCH, GATE, LOOP, REPORT. Colours degrade
gracefully and honour NO_COLOR.
"""
...
_RED, _MINT, _AMBER, _BLUE, _DIM, _BOLD, _RESET = (
    "\033[91m", "\033[92m", "\033[93m", "\033[94m", "\033[2m", "\033[1m", "\033[0m")
...
def search_line(query: str, new_n: int, total_n: int) -> None:
    # Show NEW hits this attempt and the TOTAL accumulated so far — visible
    # proof the reducer is appending across loops, not overwriting.
