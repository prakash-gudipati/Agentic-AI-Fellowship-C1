...
if __name__ == "__main__":
    ...
    print(f"LANGSMITH_ACTIVE = {is_langsmith_active()}")
    ...
    index.add(chunks)
    pipe = RAGPipeline(SimilarityRetriever(index), k=3)
    ...
    print()
    for r in get_offline_tracer().get_recent(n=1, only_roots=True):
        print(f"trace {r['trace_id'][:8]}...  "
